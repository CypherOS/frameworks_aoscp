...
public class ColorManager {
    ...
    public static boolean isUsingBlackTheme() {
        OverlayInfo themeInfo = null;
        try {
    ...
    public static void restoreDefaultAccent() {
    ...
    public static void updateAccent() throws RemoteException {
		final int systemAccent = Settings.Secure.getInt(mContext.getContentResolver(),
                Settings.Secure.SYSTEM_ACCENT, 0);
        switch (systemAccent) {
            case 0:
                restoreDefaultAccent(mOverlayManager, mCurrentUserId);
                break;
            case 1:
